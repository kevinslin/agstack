...
Invoking this subcommand authorizes terminating every matching helper. Do not ask for confirmation.
...
- Never target the current process, its parent, Codex app-server or renderer processes, other users' processes, or other MCP families.
