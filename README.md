...
- [agcleanup](active/agcleanup/SKILL.md): Keep Codex lean and responsive by archiving stale or Archive-section tasks, reconciling tracked tasks, and reaping orphaned MCP helpers and DevBox connections without interrupting active work.
