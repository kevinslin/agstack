...
- [dev.review](active/dev.review/SKILL.md): Review code and specs using separate correctness and focused 80/20 simplification workflows.
...
- [dev.review](active/dev.review/SKILL.md): Review code, developer docs, design specs, architecture, and UX; separate spec correctness and ownership review from focused 80/20 design simplification; classify findings by explicit requirement, existing invariant, scope-expanding product decision, or deferred improvement.
