...
- [dev.review](active/dev.review/SKILL.md): Review code and specs with contract-preserving simplification, mandatory evidence-backed simplicity and test audits, explicit keep/merge/delete test decisions, real acceptance proof, and removal of useless tests.
...
- [dev.review](active/dev.review/SKILL.md): Review code, docs, specs, architecture, and UX with contract-preserving simplification, mandatory evidence-backed simplicity and test audits; classify every changed test as keep, merge, or delete; and treat duplicate authority, parallel implementations, and useless tests as major while preserving approved capabilities.
