...
- [sc](active/sc/SKILL.md): Create, update, or directly optimize skills and SKILL.md content on `main` unless another branch is explicitly requested, using discoverable `$skill-name` references with synchronized dependency metadata plus canonical-source preflight, validation, packaging, and runtime synchronization.
